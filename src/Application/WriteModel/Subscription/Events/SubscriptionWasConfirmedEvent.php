...
/**
 * Class SubscriptionWasConfirmedEvent
 * @package PHPinDD\CqrsNewsletter\Application\WriteModel\Subscription\Events
 */
final class SubscriptionWasConfirmedEvent implements CarriesInformation
{
	...
	{
		return new MessageName( 'Subscription was confirmed' );
	}
